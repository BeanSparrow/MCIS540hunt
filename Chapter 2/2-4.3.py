...
def timeAdditionSeconds(milesEasy, milesTempo):
    ...
    tempoPaceMinutes = 7
    tempoPaceSeconds = 12
    totalMinutes = ((milesEasy * easyPaceMinutes) +
                    (milesTempo * tempoPaceMinutes))
    totalSeconds = ((totalMinutes * 60) + (milesEasy *
                    easyPaceSeconds) + (milesTempo * tempoPaceSeconds))
    return totalSeconds
...
def main():
    ...
    milesEasy = 2
    milesTempo = 3
    newTime(initialTimeHour, initialTimeMinute,
            timeAdditionSeconds(milesEasy, milesTempo))
